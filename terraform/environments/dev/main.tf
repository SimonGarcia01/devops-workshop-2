...
module "gateway_service" {
  ...
  env_vars = {
    ...
    REDIS_PORT     = "6379"
    JWT_SECRET     = "this-is-a-super-long-gateway-secret-key-for-testing-123456789"
    JWT_EXPIRATION = "3600000"
  }
...
module "notification_service" {
  ...
  env_vars = {
    ...
    JWT_SECRET               = var.jwt_secret
    JWT_EXPIRATION           = "3600000"
    QR_SECRET                = "this-is-a-super-long-notification-qr-secret-123456"
    QR_EXPIRATION            = "300"
  }
...
module "mobile" {
  ...
  name           = "mobile"
  namespace      = module.namespace.name
  image          = "simongarcia01/mobile:${var.image_tag}"
  container_port = 8081
  replicas       = var.replicas
  service_type   = "NodePort"
  node_port      = 30090
  ...
  env_vars = {
    API_BASE_URL = "http://auth-service:8180"
  }
